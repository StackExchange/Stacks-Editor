...
describe("markdown-serializer", () => {
    ...
    const markupSerializeData = [
        ...
        [`<h2>html heading</h2>`, `<h2>html heading</h2>`],
        [`<h3>html heading</h3>`, `<h3>html heading</h3>`],
        [`<h4>html heading</h4>`, `<h4>html heading</h4>`],
        [`<h5>html heading</h5>`, `<h5>html heading</h5>`],
        [`<h6>html heading</h6>`, `<h6>html heading</h6>`],
        [`***`, `***`],
        [`---`, `---`],
        [`___`, `___`],
        [`******`, `******`],
