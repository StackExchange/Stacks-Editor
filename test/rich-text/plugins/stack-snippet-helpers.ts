export const validBegin: string =
    `<!-- begin snippet: js hide: false console: true babel: null babelPresetReact: false babelPresetTS: false -->

`;

export const configureBegin = (hide?: boolean, console?: boolean, babel?: boolean, babelPresetReact?: boolean, babelPresetTs?: boolean): string => {
    ...
    const babelPresetReactStr = babelPresetReact ? "true" : babelPresetReact == false ? "false": "null";
    const babelPresetTsStr = babelPresetTs ? "true" : babelPresetTs == false ? "false": "null";
...
export const validJs: string =
    `<!-- language: lang-js -->

    console.log("test");

`;
export const validCss: string =
    `<!-- language: lang-css -->
